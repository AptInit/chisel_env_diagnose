...
```sh
git clone git@github.com:AptInit/chisel_env_diagnose.git
cd chisel_env_diagnose
```
...
#### Commit your changes
```sh
git commit -m 'Starting chisel_env_diagnose'
...
Alternatively, if you use Mill, follow the installation instructions on 
[Mill's website](https://mill-build.org/mill/cli/installation-ide.html#_bootstrap_scripts), and make sure a matching version is used.
...
You are ready to go.
We have a few recommended practices and things to do.
